...
var usersRouters_1 = __importDefault(require("./routers/usersRouters/usersRouters"));
var authRouters_1 = __importDefault(require("./routers/authRouters/authRouters"));
var ownerRouters_1 = __importDefault(require("./routers/ownerRouters/ownerRouters"));
...
app.use((0, connectMongo_1.connectMongo)());
...
var restartServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        app.listen(process.env.PORT, function () {
            console.log("Server has been started on port ".concat(process.env.PORT));
        });
        return [2 /*return*/];
    });
}); };
